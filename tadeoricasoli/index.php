    ...
    <div id="wrapper">
      ...
      <header id="header">
        ...
        <nav>
          <ul>
            <li>
              <a href="#footer" class="icon solid fa-info-circle">Send me</a>
            </li>
          </ul>
        </nav>
      </header>
        ...
        <div class="inner split">
          <div>
            <section>
              ...
              <p>Drop me a message and let’s chat! Whether you’ve got a question, an idea, a project in mind, or just feel like saying hi — I’m all ears. I’ll get back to you as soon as I can!</p>
            </section>
            <section>
              <h2>Follow me on ...</h2>
              <ul class="icons">
                <li>
                  <a href="https://x.com/tadeoricasoli" target="_blank" class="icon brands fa-x-twitter">
                    <span class="label">X</span>
                  </a>
                </li>
                <li>
                  <a href="https://www.facebook.com/tadeoricasoli/" target="_blank" class="icon brands fa-facebook-f">
                    <span class="label">Facebook</span>
                  </a>
                </li>
                <li>
                  <a href="https://www.instagram.com/tadeoricasoli/" target="_blank" class="icon brands fa-instagram">
